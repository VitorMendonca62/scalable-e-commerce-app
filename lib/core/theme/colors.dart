...
class AppColors {
  ...
  static const Color chart3 = Color(0xFF3B82F6);
  ...
  static const Color sidebarPrimary = Color(0xFF343434);
  static const Color sidebarPrimaryForeground = Color(0xFFFCFCFC);
